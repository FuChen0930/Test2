...
namespace ADO_NET_HW2.DataSet1TableAdapters {
...
SELECT ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhoto, LargePhotoFileName, ModifiedDate FROM Production.ProductPhoto WHERE (ProductPhotoID = @ProductPhotoID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ADO_NET_HW2.Properties.Settings.Default.AdventureWorks2022ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT          ProductPhotoID, ThumbNailPhoto, ThumbnailPhotoFileName, LargePhot" +
                ...
                "WHERE          (ModifiedDate BETWEEN @a AND @b)\r\n";
        ...
        public virtual int FillByModifiedDate(DataSet1.ProductPhotoDataTable dataTable, System.DateTime a, System.DateTime b) {
        ...
        public virtual DataSet1.ProductPhotoDataTable GetDataByModifiedDate(System.DateTime a, System.DateTime b) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((System.DateTime)(a));
            this.Adapter.SelectCommand.Parameters[1].Value = ((System.DateTime)(b));
            DataSet1.ProductPhotoDataTable dataTable = new DataSet1.ProductPhotoDataTable();
